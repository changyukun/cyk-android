...
public:
	...
	virtual status_t        setVideoSurfaceTexture(const sp<ISurfaceTexture>& surfaceTexture) = 0;
	...
	// @return OK if the invocation was made successfully.
	virtual status_t        getMetadata(bool update_only, bool apply_filter, Parcel *metadata) = 0;
};
