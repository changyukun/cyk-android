...
OMXComponentBase::OMXComponentBase(const OMX_CALLBACKTYPE *callbacks,OMX_PTR appData)
...
void OMXComponentBase::postEvent(OMX_EVENTTYPE event, OMX_U32 param1, OMX_U32 param2)
{
/*
	参数:
		1、
	...
	说明:
		1、
*/
	(*mCallbacks->EventHandler)(mComponentHandle, mAppData, event, param1, param2, NULL);
}
...
/*
	...
	说明:
		1、
*/
	return (OMXComponentBase *)((OMX_COMPONENTTYPE *)hComponent)->pComponentPrivate;
}

static OMX_ERRORTYPE SendCommandWrapper(OMX_IN  OMX_HANDLETYPE hComponent,
...
static OMX_ERRORTYPE GetParameterWrapper(OMX_IN  OMX_HANDLETYPE hComponent, 
...
/*
	...
	说明:
		1、
*/
	return getBase(hComponent)->getParameter( nParamIndex, pComponentParameterStructure);
}

static OMX_ERRORTYPE SetParameterWrapper(OMX_IN  OMX_HANDLETYPE hComponent, 
...
/*
	...
	说明:
		1、
*/
	return getBase(hComponent)->getParameter(nIndex, pComponentParameterStructure);
}

static OMX_ERRORTYPE GetConfigWrapper(OMX_IN  OMX_HANDLETYPE hComponent,
										OMX_IN  OMX_INDEXTYPE nIndex, 
...
static OMX_ERRORTYPE SetConfigWrapper(OMX_IN  OMX_HANDLETYPE hComponent,
										OMX_IN  OMX_INDEXTYPE nIndex, 
...
static OMX_ERRORTYPE GetExtensionIndexWrapper(	OMX_IN  OMX_HANDLETYPE hComponent,
...
static OMX_ERRORTYPE GetStateWrapper(OMX_IN  OMX_HANDLETYPE hComponent, OMX_OUT OMX_STATETYPE* pState)
{
/*
	参数:
		1、
...
static OMX_ERRORTYPE UseBufferWrapper(OMX_IN OMX_HANDLETYPE hComponent,
...
/*
	...
	说明:
		1、
*/
	return getBase(hComponent)->useBuffer(ppBufferHdr, nPortIndex, pAppPrivate, nSizeBytes, pBuffer);
}

static OMX_ERRORTYPE AllocateBufferWrapper(OMX_IN OMX_HANDLETYPE hComponent,
...
/*
	...
	说明:
		1、
*/
	return getBase(hComponent)->allocateBuffer(ppBuffer, nPortIndex, pAppPrivate, nSizeBytes);
}

static OMX_ERRORTYPE FreeBufferWrapper(OMX_IN  OMX_HANDLETYPE hComponent,
										OMX_IN  OMX_U32 nPortIndex,
...
static OMX_ERRORTYPE EmptyThisBufferWrapper( OMX_IN  OMX_HANDLETYPE hComponent,OMX_IN  OMX_BUFFERHEADERTYPE* pBuffer) 
{
/*
	参数:
		1、
...
static OMX_ERRORTYPE FillThisBufferWrapper(OMX_IN  OMX_HANDLETYPE hComponent,OMX_IN  OMX_BUFFERHEADERTYPE* pBuffer) 
{
/*
	参数:
		1、
...
static OMX_ERRORTYPE ComponentDeInitWrapper(OMX_IN  OMX_HANDLETYPE hComponent) 
{
/*
	参数:
		1、
...
static OMX_ERRORTYPE ComponentRoleEnumWrapper(	OMX_IN OMX_HANDLETYPE hComponent,
