...
static const size_t kNumComponents = sizeof(kComponents) / sizeof(kComponents[0]);
...
OMX_ERRORTYPE SoftOMXPlugin::makeComponentInstance(const char *name,
...
*/
	...
	for (size_t i = 0; i < kNumComponents; ++i) 
	{
		...
		CreateSoftOMXComponentFunc createSoftOMXComponent = (CreateSoftOMXComponentFunc) dlsym( 	libHandle,
...
OMX_ERRORTYPE SoftOMXPlugin::destroyComponentInstance(OMX_COMPONENTTYPE *component) 
{
/*
	参数:
		1、
